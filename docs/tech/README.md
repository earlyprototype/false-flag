...
Facts verified against the repo as of 3 Sep 2026. External platform support and
...
- [SERVER_STREAMING.md](SERVER_STREAMING.md) — which surfaces share an API session, the common REST/SSE visibility rule, the per-subscriber delivery model, and the player-safe reconnectable snapshot.
